%-----------------------------------------------------------------------
% Job saved on 04-Feb-2021 17:41:31 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {
                                                                     {
                                                                     'D:\ADNI_Project\images test\002_S_0559.nii'
                                                                     'D:\ADNI_Project\images test\002_S_0413.nii'
                                                                     'D:\ADNI_Project\images test\002_S_0295.nii'
                                                                     }
                                                                     }';
